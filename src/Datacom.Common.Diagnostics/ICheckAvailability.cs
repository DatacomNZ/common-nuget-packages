...
namespace Datacom.Common.Diagnostics
{
    ...
    public interface ICheckAvailability
    {
        ...
        /// Intended to be polled frequently, so limt the extent and expense of the checks.
        ...
        /// <summary>
        /// Provide a list of warnings in relation to the service being monitored. E.g. for a filestore, the file system is nearing its capacity.
        /// </summary>
